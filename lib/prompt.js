...
===META===
{"is_film_or_tv": true/false, "search_title": "<exact film/show title for image lookup, or empty string>", "year": "<release year or empty>", "essay_title": "<a striking 4-9 word title for the essay>", "deck": "<one-sentence subtitle, max 20 words>"}
===END===`;
