...
// Fallback: a dedicated, search-free call that reliably returns just an image subject.
// Used when the research pass fails to emit a usable image_subject.
export const IMAGE_SUBJECT_SYSTEM = `Given an essay topic, name ONE concrete, real, searchable subject for a public-domain image that would illustrate it well. Prefer: a named historical person, a famous artwork or painting, a sculpture or bust, a landmark, or a place. Avoid abstractions. Respond with ONLY the subject as plain text on a single line — no quotes, no explanation, no punctuation at the end. Example inputs and outputs:
Topic: "Bhagavad Gita chapter 2 — Krishna and Arjuna" -> Krishna Arjuna Kurukshetra painting
Topic: "Marcus Aurelius Meditations" -> Marcus Aurelius bust
Topic: "FDR's grave and the quote on it" -> Franklin D. Roosevelt
Topic: "Carl Sagan's Pale Blue Dot" -> Pale Blue Dot photograph Voyager`;
